...
class RegistroForm(forms.ModelForm):
    contraseña_cliente = forms.CharField(
        widget=forms.PasswordInput(
            attrs={"class": "input-auth", "placeholder": "Crea una contraseña segura"}
        ),
        min_length=8,
        label="Contraseña",
    )
    confirmar_contraseña = forms.CharField(
        widget=forms.PasswordInput(
            attrs={"class": "input-auth", "placeholder": "Repite la contraseña"}
        ),
        min_length=8,
...
class LoginForm(forms.Form):
    correo_cliente = forms.EmailField(
        ...
        widget=forms.EmailInput(
            attrs={"class": "input-auth", "placeholder": "correo@ejemplo.cl"}
        ),
    )
    contraseña_cliente = forms.CharField(
        widget=forms.PasswordInput(
            attrs={"class": "input-auth", "placeholder": "Ingresa tu contraseña"}
        ),
        label="Contraseña",
    )
...
class CambiarContrasenaForm(forms.Form):
    contrasena_actual = forms.CharField(
        ...
        widget=forms.PasswordInput(
            attrs={"class": "input-auth", "placeholder": "Ingresa tu contraseña actual"}
        ),
    )
    nueva_contrasena = forms.CharField(
        ...
        min_length=8,
        widget=forms.PasswordInput(
            attrs={"class": "input-auth", "placeholder": "Crea una nueva contraseña"}
        ),
    )
    confirmar_contrasena = forms.CharField(
        ...
        min_length=8,
        widget=forms.PasswordInput(
            attrs={"class": "input-auth", "placeholder": "Repite la nueva contraseña"}
        ),
    )
