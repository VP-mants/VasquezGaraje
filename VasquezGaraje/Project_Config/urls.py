...
urlpatterns = [
    ...
    path(
        "recuperar_contraseña/", views.recuperar_contraseña, name="recuperar_contraseña"
    ),
    ...
    path(
        "panel/inventario/nuevo/", views.admin_insumo_nuevo, name="admin_insumo_nuevo"
    ),
    path(
        "panel/inventario/editar/<int:id>/",
        views.admin_insumo_editar,
        name="admin_insumo_editar",
    ),
    path(
        "panel/inventario/eliminar/<int:id>/",
        views.admin_insumo_eliminar,
        name="admin_insumo_eliminar",
    ),
    path("panel/usuarios/", views.admin_usuarios, name="admin_usuarios"),
    path(
        "panel/reservas/editar/<int:id>/",
        views.admin_editar_reserva,
        name="admin_editar_reserva",
    ),
]
